 ...
 * 
 */
package com.feng.learn.collection.mapBetter;
...
public class HashMap<K, V> implements Map<K, V> {
	...
	*/
	...
	private class EntryItr extends HashItr<java.util.Map.Entry<K, V>> {
	 ...
	 * @return
	 */
	private Set<java.util.Map.Entry<K, V>> newEntrySet() {
		if (null == entrySet) {
	...
	private class EntrySet implements Set<java.util.Map.Entry<K, V>> {
		...
		public Object[] toArray() {
			Object[] a = new Object[size];
			Iterator<java.util.Map.Entry<K, V>> itr = iterator();
		...
		public boolean remove(Object o) {
			...
			for (Iterator<java.util.Map.Entry<K, V>> itr = iterator(); itr.hasNext();) {
